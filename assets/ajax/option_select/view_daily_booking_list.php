...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title"><b><i class="fas fa-chart-pie mr-1"></i> Daily Booking</b></h3>
		<div id="export_buttons" style="float: right;height: 23px;"></div>
	</div>
	<div class="card-body">
...
$(document).ready(function() {
	...
	var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
		"serverSide": true,
		"ajax": "<?php echo $home; ?>assets/ajax/data_table/todays_booking_information_dashboard_datatable.php"+table_info,
