<?php
if(isset($_GET['ipo_id_investment_payment'])){ 
	...
	$table = 'ipo_member_wallet_insert_logs';
	$primaryKey = 'id';
	$where = "ipo_id = '".$_GET['ipo_id_investment_payment']."'";
	$columns = array(
		array('db' => 'id', 'dt' => 0 ),
		array(
...
<div class="row">
	<div class="col-sm-12">
		<h5 style="text-decoration:underline;">Investment Payment Information</h5>
	</div>
	<div class="col-sm-12">
		<div class="row">
			<div class="col-sm-12">
				<div style="float:right;" id="export_buttons_investment_payment"></div>
			</div>
			<div class="col-sm-12 body">
				<table class="table table-sm table-bordered" id="investment_payment_information">
					<thead>
						<tr>
							<th>ID</th>
							<th>Date</th>
							<th>Agreement Type</th>
							<th>Info<small>(Widthdraw Typw)</small></th>
							<th>Commission</th>
							<th>Amount</th>
						</tr>
					</thead>
...
$('document').ready(function(){
	var command = "?ipo_id_investment_payment=<?php echo $_MEMBER_INFO['ipo_id']; ?>";
    var table_booking = $('#investment_payment_information').DataTable({
        ...
        "ajax": "<?php echo $home; ?>assets/ajax/ipo/profile/investmennt_payment.php"+command,
		dom: 'lBfrtip',
	...
	table_booking.buttons().container().appendTo($('#export_buttons_investment_payment'));	
})
</script>
<?php } ?>