...
if(isset($_POST['sms_id'])){ 
	$sms = mysqli_fetch_assoc($mysqli->query("select * from sms_logs where id = '".$_POST['sms_id']."'"));
	$member = mysqli_fetch_assoc($mysqli->query("select * from member_directory where phone_number like '%".$sms['number']."'"));

?>
<div class="row">
	<div class="col-sm-12">
		<div style="text-align:left;padding:15px;">	
			Time: <b> <?php echo $sms['days'].', '.$sms['time'].' '.$sms['ampm'].' - '.$sms['data']; ?></b><br />
