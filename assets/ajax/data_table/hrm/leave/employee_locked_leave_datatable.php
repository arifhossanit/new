...
$date = new DateTime($_GET['date'] . '-01');

$where = "leave_lock is not null AND STR_TO_DATE(start_days, '%d/%m/%Y') between '".$date->format('Y-m-01')."' AND '".$date->format('Y-m-t')."'";
$columns = array(
	array( 
		'db' => 'id', 
		'dt' => 0,
