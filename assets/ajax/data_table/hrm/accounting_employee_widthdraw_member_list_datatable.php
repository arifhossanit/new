...
$columns = array(
	...
	array(
        ...
        'dt'        => 6,
        'formatter' => function( $d, $row ) { global $mysqli;
			return '<button onclick="return view_member_profile('.$d.')" type="button" class="btn btn-xs btn-danger" title=""><i class="fas fa-money-check-alt"></i>&nbsp;&nbsp;&nbsp;Approved Request</button>';
        }
    )
);
