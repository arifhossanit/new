...
$columns = array(
	...
	array(
		...
		'formatter' => function( $d, $row ) {
			global $mysqli;
			$info = mysqli_fetch_assoc($mysqli->query("select * from branch_elictric_bill where id = '".$d."'"));
			if($info['status'] == 1){
    ...
    array(
        ...
        'formatter' => function( $d, $row ) { global $home; global $mysqli;
			...
			return '
				<form action="'.$home.'admin/create/front-office/add-electrict-bill" method="post">
