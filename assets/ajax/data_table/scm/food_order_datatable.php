...
$columns = array(
    ...
    array( 
		...
		'formatter' => function( $d, $row ) {global $mysqli;
            $total_price = mysqli_fetch_assoc($mysqli->query("SELECT sum(unit_price * requested_amount) as total_sum from scm_product_order_details where pre_purchase_order_id = '".$d."'"));
    ...
    array(
        ...
        'formatter' => function( $d, $row ) {
            if($d == '0'){
                ...
                return '<span class="badge badge-info">Approved/Vendor Pending</span>';
            }else if($d == '2'){
                return '<span class="badge badge-info">Vendor Assigned</span>';
            }else if($d == '4'){
