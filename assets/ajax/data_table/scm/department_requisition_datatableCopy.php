...
if($_SESSION['super_admin']['department'] == '2805597208697462328'){ // Branch Operation
    $where = " department_requested_by = '".$_SESSION['user_info']['department']."' AND branch_requested_for = '{$_SESSION['super_admin']['branch']}'";
}else{
    $where = " department_requested_by = '".$_SESSION['user_info']['department']."'";
}
...
$columns = array(
    ...
    array( 
		...
		'formatter' => function( $d, $row ) {global $mysqli;global $home;
            ...
            if($row[6] == '2' AND $row[8] == $_SESSION['user_info']['department'] AND $_SESSION['user_info']['d_head']){ // receive product
