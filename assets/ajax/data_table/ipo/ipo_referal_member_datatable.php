...
$primaryKey = 'id';
$where = "ipo_id = '".$ipo_id."' and status = '1' and aproval = '1'";
$columns = array(
    array('db' => 'id','dt' => 0 ),
	array(
        'db'        => 'booking_id',
	...
	array(
        ...
        'formatter' => function( $d, $row ) {
			return '<button onclick="return view_my_commissions('.$d.')" type="button" class="btn btn-xs btn-warning">View Comissions</button>';			
        }
    )
);
