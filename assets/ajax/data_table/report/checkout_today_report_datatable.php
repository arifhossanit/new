...
if(!empty($_GET['date_short'])){
	$ert = explode('-',$_GET['date_short']);
	$date_short = $ert[2].'/'.$ert[1].'/'.$ert[0];
}else{
...
$checkout = " AND checkout_date = '".$date_short."' ";
$condition = "".$checkout." ".$occupation." ".$religion." ".$h_t_f_u." ".$package_category." ".$package." ".$parking." ".$authorization."";
