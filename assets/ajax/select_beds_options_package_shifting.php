...
<?php 
		...
		if($bed['status'] == 1){
			if($bed['uses'] == 0 ){
?>
													<button onclick="return get_bet_info_package_shifting(<?php echo $bed['id']; ?>)" class="btn btn-info" id="" type="button" style="width:100%;margin-bottom:10px;"><?php echo $bed['bed_name']; ?></button>
<?php
			}
		}else{
?>
