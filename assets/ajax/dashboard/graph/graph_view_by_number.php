...
if(isset($_POST['graph_number'])){ $graph = $_POST['graph_number']; ?>
	...
	<?php }else if($graph == 4){ ?>
		...
		<?php
			...
			$sql = $mysqli->query("SELECT COUNT(branch_id) as nmbr, branch_name FROM booking_info $pck_branches GROUP BY branch_id ORDER BY branch_name DESC");
	...
	<?php }else if($graph == 5){ 
		...
		$vip_student = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_student from member_directory where bet_type like '%VIP%' and occupation like '%Student%' and check_in_date like '%".$month_year."%' "));
		$vip_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_job_holder from member_directory where bet_type like '%VIP%' and occupation like '%Job Holder%' and check_in_date like '%".$month_year."%' "));
		$vip_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_business_man  from member_directory where bet_type like '%VIP%' and occupation like '%Business Man%' and check_in_date like '%".$month_year."%' "));
		$vip_house_wife = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_house_wife from member_directory where bet_type like '%VIP%' and occupation like '%Housewife%' and check_in_date like '%".$month_year."%' "));
		$vip_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_doctor from member_directory where bet_type like '%VIP%' and occupation like '%Doctor%' and check_in_date like '%".$month_year."%' "));
		$vip_teacher = mysqli_fetch_assoc($mysqli->query("select count(id) as vip_teacher from member_directory where bet_type like '%VIP%' and occupation like '%Teacher%' and check_in_date like '%".$month_year."%' "));

		$cozy_student = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_student from member_directory where bet_type like '%Cozy%' and occupation like '%Student%' and check_in_date like '%".$month_year."%' "));
		$cozy_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_job_holder from member_directory where bet_type like '%Cozy%' and occupation like '%Job Holder%' and check_in_date like '%".$month_year."%' "));
		$cozy_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_business_man from member_directory where bet_type like '%Cozy%' and occupation like '%Business Man%' and check_in_date like '%".$month_year."%' "));
		$cozy_house_wife = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_house_wife from member_directory where bet_type like '%Cozy%' and occupation like '%Housewife%' and check_in_date like '%".$month_year."%' "));
		$cozy_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_doctor from member_directory where bet_type like '%Cozy%' and occupation like '%Doctor%' and check_in_date like '%".$month_year."%' "));
		$cozy_teacher = mysqli_fetch_assoc($mysqli->query("select count(id) as cozy_teacher from member_directory where bet_type like '%Cozy%' and occupation like '%Teacher%' and check_in_date like '%".$month_year."%' "));

		$elegant_student = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_student from member_directory where bet_type like '%Elegant%' and occupation like '%Student%' and check_in_date like '%".$month_year."%' "));
		$elegant_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_job_holder from member_directory where bet_type like '%Elegant%' and occupation like '%Job Holder%' and check_in_date like '%".$month_year."%' "));
		$elegant_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_business_man from member_directory where bet_type like '%Elegant%' and occupation like '%Business Man%' and check_in_date like '%".$month_year."%' "));
		$elegant_house_wife = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_house_wife from member_directory where bet_type like '%Elegant%' and occupation like '%Housewife%' and check_in_date like '%".$month_year."%' "));
		$elegant_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_doctor from member_directory where bet_type like '%Elegant%' and occupation like '%Doctor%' and check_in_date like '%".$month_year."%' "));
		$elegant_teacher = mysqli_fetch_assoc($mysqli->query("select count(id) as elegant_teacher from member_directory where bet_type like '%Elegant%' and occupation like '%Teacher%' and check_in_date like '%".$month_year."%' "));

		$exclusive_student = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_student from member_directory where bet_type like '%Exclusive%' and occupation like '%Student%' and check_in_date like '%".$month_year."%' "));
		$exclusive_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_job_holder from member_directory where bet_type like '%Exclusive%' and occupation like '%Job Holder%' and check_in_date like '%".$month_year."%' "));
		$exclusive_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_business_man from member_directory where bet_type like '%Exclusive%' and occupation like '%Business Man%' and check_in_date like '%".$month_year."%' "));
		$exclusive_house_wife = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_house_wife from member_directory where bet_type like '%Exclusive%' and occupation like '%Housewife%' and check_in_date like '%".$month_year."%' "));
		$exclusive_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_doctor from member_directory where bet_type like '%Exclusive%' and occupation like '%Doctor%' and check_in_date like '%".$month_year."%' "));
		$exclusive_teacher = mysqli_fetch_assoc($mysqli->query("select count(id) as exclusive_teacher from member_directory where bet_type like '%Exclusive%' and occupation like '%Teacher%' and check_in_date like '%".$month_year."%' "));

		$economy_student = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_student from member_directory where bet_type like '%Economy%' and occupation like '%Student%' and check_in_date like '%".$month_year."%' "));
		$economy_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_job_holder from member_directory where bet_type like '%Economy%' and occupation like '%Job Holder%' and check_in_date like '%".$month_year."%' "));
		$economy_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_business_man from member_directory where bet_type like '%Economy%' and occupation like '%Business Man%' and check_in_date like '%".$month_year."%' "));
		$economy_house_wife = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_house_wife from member_directory where bet_type like '%Economy%' and occupation like '%Housewife%' and check_in_date like '%".$month_year."%' "));
		$economy_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_doctor from member_directory where bet_type like '%Economy%' and occupation like '%Doctor%' and check_in_date like '%".$month_year."%' "));
		$economy_teacher = mysqli_fetch_assoc($mysqli->query("select count(id) as economy_teacher from member_directory where bet_type like '%Economy%' and occupation like '%Teacher%' and check_in_date like '%".$month_year."%' "));

		$total_students = mysqli_fetch_assoc($mysqli->query("select count(id) as total_students from member_directory where occupation like '%Student%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));
		$total_teachers = mysqli_fetch_assoc($mysqli->query("select count(id) as total_teachers from member_directory where occupation like '%Teacher%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));
		$total_job_holder = mysqli_fetch_assoc($mysqli->query("select count(id) as total_job_holder from member_directory where occupation like '%Job Holder%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));
		$total_business_man = mysqli_fetch_assoc($mysqli->query("select count(id) as total_business_man from member_directory where occupation like '%Business Man%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));
		$total_housewife = mysqli_fetch_assoc($mysqli->query("select count(id) as total_housewife from member_directory where occupation like '%Housewife%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));
		$total_doctor = mysqli_fetch_assoc($mysqli->query("select count(id) as total_doctor from member_directory where occupation like '%Doctor%' AND bet_type != '' and check_in_date like '%".$month_year."%' "));

		//total guest count this one month by bed type
		$total_vip = mysqli_fetch_assoc($mysqli->query("select count(id) as total_vip from member_directory where bet_type like '%VIP%' and check_in_date like '%".$month_year."%' "));
		$total_cozy = mysqli_fetch_assoc($mysqli->query("select count(id) as total_cozy from member_directory where bet_type like '%Cozy%' and check_in_date like '%".$month_year."%' "));
		$total_elegant = mysqli_fetch_assoc($mysqli->query("select count(id) as total_elegant from member_directory where bet_type like '%Elegant%' and check_in_date like '%".$month_year."%' "));
		$total_exclusive = mysqli_fetch_assoc($mysqli->query("select count(id) as total_exclusive from member_directory where bet_type like '%Exclusive%' and check_in_date like '%".$month_year."%' "));
		$total_economy = mysqli_fetch_assoc($mysqli->query("select count(id) as total_economy from member_directory where bet_type like '%Economy%' and check_in_date like '%".$month_year."%' "));
		$total_guest = mysqli_fetch_assoc($mysqli->query("select count(id) as total_guest from member_directory where bet_type != '' and occupation != '' and check_in_date like '%".$month_year."%' "));

		//total beds count by room type
		$total_economy_rooms = mysqli_fetch_assoc($mysqli->query("select count(distinct(beds.id)) as TotalBeds from beds left join rooms on (beds.branch_id = rooms.branch_id and beds.room_name = rooms.room_name and beds.unit_id = rooms.unit_id) where rooms.room_type like '%Economy%' "));
		$total_vip_rooms = mysqli_fetch_assoc($mysqli->query("select count(distinct(beds.id)) as TotalBeds from beds left join rooms on (beds.branch_id = rooms.branch_id and beds.room_name = rooms.room_name and beds.unit_id = rooms.unit_id) where rooms.room_type like '%VIP%' "));
		$total_elegant_rooms = mysqli_fetch_assoc($mysqli->query("select count(distinct(beds.id)) as TotalBeds from beds left join rooms on (beds.branch_id = rooms.branch_id and beds.room_name = rooms.room_name and beds.unit_id = rooms.unit_id) where rooms.room_type like '%Elegant%' "));
		$total_exclusive_rooms = mysqli_fetch_assoc($mysqli->query("select count(distinct(beds.id)) as TotalBeds from beds left join rooms on (beds.branch_id = rooms.branch_id and beds.room_name = rooms.room_name and beds.unit_id = rooms.unit_id) where rooms.room_type like '%Exclusive%' "));
		$total_cozy_rooms = mysqli_fetch_assoc($mysqli->query("select count(distinct(beds.id)) as TotalBeds from beds left join rooms on (beds.branch_id = rooms.branch_id and beds.room_name = rooms.room_name and beds.unit_id = rooms.unit_id) where rooms.room_type like '%Cozy%' "));
		
		?>
				<div id="chartContainer" class="row" style="background-color:dimgrey;height: 370px;">
                    <div class="col-md-12" style="padding:5px;">
                        <center style="color:white;font-weight:900;font-size:18pt;">Occupation wise Booking</center>
                    </div>
                    <div class="col-md-12">
                        <table class="table table-bordered" id="chartContainer_packageTable" style="font-size:12pt;font-weight:900;width:100%;">
                            <thead>
                                <th>Package</th>
                                <th>Student</th>
                                <th>Job Holder</th>
	...
	<?php }else if($graph == 9){ ?>
		...
		<?php
			...
			if(!empty($_POST['branch_id'])){ $pck_branches_monthly = "WHERE discount_member.branch_id = '".$_POST['branch_id']."' AND discount_member.data LIKE '%".date('m/Y')."%'"; }else{ $pck_branches_monthly = "WHERE discount_member.data LIKE '%".date('m/Y')."%'"; }
			$sql = $mysqli->query("SELECT sum(amount) as nmbr, discount_member.branch_id FROM discount_member LEFT JOIN branches ON discount_member.branch_id = branches.branch_id $pck_branches_monthly GROUP BY discount_member.branch_id ORDER BY branches.branch_name ASC");
	...
	<?php }else if($graph == 10){ ?>
		...
		<?php
			...
			$sql = $mysqli->query("SELECT COUNT(branch_id) as nmbr, branch_name, branch_id FROM booking_info $pck_branches_monthly GROUP BY branch_id ORDER BY branch_name DESC");
			while($row = mysqli_fetch_assoc($sql)){
	...
	<?php }else if($graph == 11){ ?>
		...
		<?php
			...
			$sql = $mysqli->query("SELECT COUNT(branch_id) as nmbr, branch_name, branch_id FROM booking_info WHERE data = '".date('d/m/Y')."' GROUP BY branch_id ORDER BY branch_name DESC");
			...
			// 	} 
			// }
			$todays_bookinga = 	(isset($todays_booking)) ? $todays_booking : '';	
		?>
		<script>
			$('document').ready(function(){	
	...
	<?php }else if($graph == 12){ ?>
		...
		<?php
			...
			$booking_id_i = rtrim($book_id,','); $sql = $mysqli->query("SELECT COUNT(branch_id) as nmbr, branch_name, branch_id FROM rent_info WHERE booking_id IN (".$booking_id_i.") AND rent_status = 'Paid' AND data = '".date('d/m/Y')."' AND data_three = 'renew' AND status = '1' GROUP BY branch_id ORDER BY branch_name DESC");
	...
	<?php }else if($graph == 14){ ?>
		...
		<?php error_reporting(0); 
			...
			$sql = $mysqli->query("select * from branches $branches order by branch_name DESC");
			while($row = mysqli_fetch_assoc($sql)){
				if($row['id'] != '1'){
	...
	<?php
		...
		} $sql = $mysqli->query("SELECT * FROM sub_package_category ORDER BY sequence DESC");
	...
	<?php }else if($graph == 18){ ?>
		...
		<?php
			...
			while($row = mysqli_fetch_assoc($sql)){
				...
				$total_value = 0;
				$sql_2 = $mysqli->query("select * from booking_receipt_logs where uploader_info LIKE '%".$row['email']."%' AND count_reword = ''");
				while($booking = mysqli_fetch_assoc($sql_2)){
					$package = mysqli_fetch_assoc($mysqli->query("select * from packages where id = '".$booking['package']."'"));
	...
	<?php }else if($graph == 21){ ?>
		...
		<?php
			...
			while($row = mysqli_fetch_assoc($sql)){
				...
				if($row['h_t_f_u'] == 'INVESTORS' ){ $SH_Share_Holder = $SH_Share_Holder + 1; }else
			...
			$member_howtofindus_number_oco = array(
				...
				array("label"=> "INVESTORS", "y"=> $SH_Share_Holder),
	...
	<?php }else if($graph == 26){ ?>
		...
		<?php
			...
			$thirty_days = array();
			while($row = mysqli_fetch_assoc($sql)){
				$package = mysqli_fetch_assoc($mysqli->query("SELECT packages.*, sub_package_category.sub_package_name from packages INNER JOIN sub_package_category on sub_package_category.id = packages.sub_category_id where packages.id = '".$row['package']."'"));
				if($package['package_days'] == '1' ){ $one_day = $one_day + 1; }
				if($package['package_days'] == '3' ){ $three_day = $three_day + 1; }
				if($package['package_days'] == '7' ){ $seven_day = $seven_day + 1; }
				if($package['package_days'] == '15' ){ $fifteen_day = $fifteen_day + 1; }
				if($package['package_days'] == '30' ){
					if($package['try_us'] == 1){
						if(!isset($thirty_days['Try Us 30 Days'])){
							$thirty_days['Try Us 30 Days'] = 1;
						}else{
							$thirty_days['Try Us 30 Days'] += 1;
						}
					}else{
						if(!isset($thirty_days[$package['sub_package_name']])){
							$thirty_days[$package['sub_package_name']] = 1;
						}else{
							$thirty_days[$package['sub_package_name']] += 1;
						}
					}
			...
			foreach($thirty_days as $idx=>$row){
				array_push($daily_booking_percentage_chart, array(
					"label" => $idx, "y" => $row
				));
			}
		?>
	...
	<?php }else if($graph == 27){ ?>
		...
		<?php
			...
			while($row = mysqli_fetch_assoc($sql)){
				...
				if($package['package_days'] == '30' ){
					if($package['try_us'] == 1){
						if(!isset($thirty_days['Try Us'])){
							$thirty_days['Try Us'] = 1;
						}else{
							$thirty_days['Try Us'] += 1;
						}
					}else{
			...
			foreach($thirty_days as $idx=>$row){
				array_push($monthly_booking_percentage_chart, array(
					"label" => $idx, "y" => $row
				));
			}
		?>
	...
	<?php }else if($graph == 31){ ?>		
		<?php
			...
			while($row = mysqli_fetch_assoc($sql)){
				...
				while($booking = mysqli_fetch_assoc($sql_2)){
					$package = mysqli_fetch_assoc($mysqli->query("select * from packages where id = '".$booking['package']."'"));
					if(isset($package['sub_category_id'])){
						$get_value = mysqli_fetch_assoc($mysqli->query("select * from sub_package_category where id = '".$package['sub_category_id']."'"));
						$total_value = $total_value + $get_value['booking_value'];
					}
	...
	<?php }else if($graph == 38){ ?>
		<div id="chartContainer_38" style="height: 370px; width: 100%;"></div>
		<?php
			$this_month = date('m');
			$this_year = date('Y');
			$d = array();
			...
			if( intval(date('d')) == intval(substr($i,0,2))){
				break;
				}
			}

			if(!empty($_POST['branch_id'])){
				 $branches = $_POST['branch_id']; 

				foreach($d as $i ){			
						if(strlen($i) == 9){
							$i = '0'.$i;
						}		
						$paid = mysqli_fetch_assoc($mysqli->query("SELECT sum(occupency_number) as nmbr FROM daily_ocupide_number where data = '".$i."' and branch_id like '%".$_POST['branch_id']."%' "));
						if(!empty($paid['nmbr']) AND $paid['nmbr'] > 0){ $count_p = $paid['nmbr']; }else{ $count_p = '0'; }
						$paid_graph_1[] =array( "label" => substr($i,0,10), "y" => $count_p );
					}
				...
				foreach($d as $i ){			
					...
					$paid = mysqli_fetch_assoc($mysqli->query("SELECT sum(occupency_number) as nmbr FROM daily_ocupide_number where data = '".$i."' "));
					if(!empty($paid['nmbr']) AND $paid['nmbr'] > 0){ $count_p = $paid['nmbr']; }else{ $count_p = '0'; }
					$paid_graph_1[] =array( "label" => substr($i,0,10), "y" => $count_p );
				}
			 }
		...
		<script>
			$('document').ready(function(){
				...
				legend:{ cursor: "pointer", verticalAlign: "center", horizontalAlign: "right", itemclick: toggleDataSeries },
				data: [{
					type: "column", name: "Occupied", color: "#20c997", indexLabel: "{y}", yValueFormatString: "#0.##", showInLegend: true,
					dataPoints: <?php echo json_encode($paid_graph_1, JSON_NUMERIC_CHECK); ?>
				}]
			}); chart_2.render();		 
			function toggleDataSeries(e){ if (typeof(e.dataSeries.visible) === "undefined" || e.dataSeries.visible) { e.dataSeries.visible = false; } else{ e.dataSeries.visible = true; } chart_2.render(); } })
		</script>
	<?php }else if($graph == 39){ ?>
		<div id="seat_wise_booking" style="height: 370px; width: 100%;"></div>
		<?php
		error_reporting(0); 
			if(!empty($_POST['branch_id'])){ 
		...
		<script>
		$('document').ready(function(){
			var seat_wise_booking = new CanvasJS.Chart("seat_wise_booking", {
				theme: "light1", //"light1", "dark1", "dark2"
				exportFileName: "Top 5 Branch Wise Booking Graph", exportEnabled: true, animationEnabled: true, zoomEnabled: true, zoomType: "xy",
				axisY:{ 
					suffix: "", 
			...
			seat_wise_booking.render();
		})
		</script>
	<?php }else if($graph == 40){ ?>
