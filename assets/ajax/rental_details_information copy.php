					...
					<header class="clearfix" style="margin-bottom:30px;">
						<div class="container">
							...
							<div style="width:100%;float:left;margin-top:20px;">
								<center>
									<h1 style="font-size:3em;font-weight:600;margin: 0.3em 0;"><u>Rental Receipt</u></h1>
								</center>
							</div>
						</div>
					</header>
						...
						<div class="container">
							...
							<table class="subtotal" border="0" cellspacing="0" cellpadding="0" style="font-size:20px;">
								...
								<tbody>
									...
									<tr>
										<?php
										if($row['discount_money'] > 0){
											$dis_mnt = $row['discount_money'];
										}else{
											if($row['dis_aamt'] == 1){
												$dis_check = mysqli_fetch_assoc($mysqli->query("select * from discount_member where booking_id = '".$row['booking_id']."'"));
												$brento_n_c = mysqli_fetch_array($mysqli->query("select count(*) from rent_info where booking_id = '".$row['booking_id']."' and payment_pattern = '1'"));
									...
									<tr>
										<td class="desc">
											<h3 style="color:#000;">Electricity Bill</h3>
										</td>
								...
								<div> <!-- redundent div for printing -->
									...
									<div style="width:95%;right:5%;" class="row justify-content-between bottom-page">
										...
										<div class="col-print-7">
											<div class="title" style="font-size: 45px;font-weight: 600;color: #ffc107"><?php echo $id['transaction_id']; ?> </div>
										</div>
									</div>
								</div>
							</div>
