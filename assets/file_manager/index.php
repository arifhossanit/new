...
$custom_path = 'assets/uploads/file_manager/'.rahat_encode(md5($_SESSION['user_info']['employee_id']));
$root_path = $_SERVER['DOCUMENT_ROOT'].'/'.$req_urldd[1].'/'.$custom_path;
if (!file_exists($root_path)) {
    mkdir($root_path, 0777, true);
}
$root_url = $req_urldd[1].'/'.$custom_path;
$http_host = $_SERVER['HTTP_HOST'];
$directories_users = array();
$iconv_input_encoding = 'UTF-8';
$datetime_format = 'l, d-m-Y (h:i:sa)';
        ...
        <div class="card <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <?php /* ?><p class="break-word"><?php echo lng('SourceFolder') ?>: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH)) ?><br><?php */ ?>
                        <label for="inp_copy_to"><?php echo lng('DestinationFolder') ?>:</label>
                        <?php /* echo FM_ROOT_PATH; */?>root/
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    <div class="path">
        <p><b>Copying</b></p>
        <p class="break-word">
            <?php /* ?>Source path: <?php echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . $copy)) ?><br><?php */ ?>
            Destination folder: root/ <?php /* echo fm_enc(fm_convert_win(FM_ROOT_PATH . '/' . FM_PATH))  */ ?>
        </p>
        <p>
    ...
    <div class="row">
        <div class="col-12">
            <?php if(!$quickView) { ?>
                ...
                <p class="break-word">
                    <?php /* ?>Full path: <?php echo fm_enc(fm_convert_win($file_path)) ?><br><?php */?>
                    File
                ...
                <p>
                    ...
                    <?php /* ?><b><a href="<?php echo fm_enc($file_url) ?>" target="_blank"><i class="fa fa-external-link-square"></i> <?php echo lng('Open') ?></a></b><?php */ ?>
                    &nbsp;
                    <?php
                    // ZIP actions
...
//https://docs.google.com/viewer?embedded=true&hl=en&url='
//
            if($is_onlineViewer) {
                if($online_viewer == 'google') {
                    echo '<iframe src="https://docs.google.com/gview?url=' . fm_enc($file_url) . '&embedded=true" frameborder="no" style="width:100%;min-height:460px"></iframe>';
                } else if($online_viewer == 'microsoft') {
                    echo '<iframe src="https://view.officeapps.live.com/op/embed.aspx?src=' . fm_enc($file_url) . '" frameborder="no" style="width:100%;min-height:780px"></iframe>';
                }
            } elseif ($is_zip) {
                // ZIP content
                if ($filenames !== false) {
...
<form action="" method="post" class="pt-3">
            ...
            foreach ($folders as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY): ?>
                        ...
                        <?php endif; ?>
                        <?php /* ?><a title="<?php echo lng('DirectLink')?>" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f . '/') ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i></a><?php */ ?>
                    </td>
                </tr>
                <?php
                flush();
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php endif; ?>
                        <?php /* ?><a title="<?php echo lng('DirectLink') ?>" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-link"></i></a><?php */ ?>
    ...
    <div class="row">
        ...
        <?php /* ?><div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div><?php */ ?>
        <?php else: ?>
            <?php /* ?><div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">File Manager <?php echo VERSION; ?></a></div><?php */ ?>
        <?php endif; ?>
    </div>
...
<?php 
$req_urldde = explode("/",$_SERVER['REQUEST_URI']);
$auto_url_findere = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off' || $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://" . $_SERVER['HTTP_HOST']."/".$req_urldde[1].'/';
$home_file_manager = $auto_url_findere;
?>
...
<script>
    ...
    //TFM Config
    window.curi = "<?php echo $home_file_manager; ?>/assets/file_manager/config.json", window.config = null;
