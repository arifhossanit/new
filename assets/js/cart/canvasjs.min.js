(function() {
    ...
    function hb(k) {
        if (!ib) {
            ...
            if (k.creditHref && k.creditText) {
                k._creditLink || (k._creditLink = document.createElement("a"), k._creditLink.setAttribute("class", "canvasjs-chart-credit"), k._creditLink.setAttribute("title", "JavaScript Charts"), k._creditLink.setAttribute("style", "display:none !important;outline:none;margin:0px;position:absolute;right:2px;top:" + (k.height - 14) + "px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
    ...
    w = Oa.Chart = function() {
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (q > g) var B = g,
                    ...
                    q = B;
                if (n.scaleBreaks)
                    for (B = 0; !f && B < n.scaleBreaks._appliedBreaks.length; B++) f = n.scaleBreaks._appliedBreaks[B].startValue <= q && n.scaleBreaks._appliedBreaks[B].endValue >= g;
                if (isFinite(n.dataInfo.minDiff))
                    if (B = n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && B < Math.pow(n.dataInfo.minDiff,
        ...
        m.prototype.renderIndexLabels = function(a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== A && "" !== A) {
                    ...
                    g.y = q;
                    g.render(!0);
                    m && ("inside" !== t && (0 > p.indexOf("bar") && ("error" !== p || !h.axisSwapped) && h.point.x > c.x1 && h.point.x < c.x2 ||
                    ...
                    if (0 < p.length) {
                        for (var J = !1, t = 0; t < p.length; t++)
                            if (x = p[t].getTime ? p[t].x.getTime() : p[t].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !J)))
                                if ("number" !== typeof p[t].y) 0 < t && !(h.connectNullData || J || m) && (c.stroke(),
                                    s && b.stroke()), J = !0;
                                else {
                                    var C = r;
                                    x = a.axisX.convertValueToPixel(x);
            ...
            function d(a) {
                ...
                if (0 < a.length) {
                    ...
                    for (var c = 0; c < a.length - 3; c += 3)
                        if (b.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y), s && e.bezierCurveTo(a[c + 1].x, a[c + 1].y, a[c + 2].x, a[c + 2].y, a[c + 3].x, a[c + 3].y),
                ...
                for (p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < B.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < B.length; f++)
                            if (B[f].getTime ? z = B[f].x.getTime() :
                                ...
                                (B[f].indexLabel || g.indexLabel || B[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                    ...
                                    point: {
                                        x: l + (m - l) / 2,
                                        y: 0 > B[f].y === a.axisY.reversed ? u : t
                                    },
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0), 0 < u[b] && (n = a.axisY.convertValueToPixel(u[b]),
                                    C = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n);
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0), C = a.axisY.convertValueToPixel(z[b]), n = "undefined" !== typeof l[b] ? l[b] : q, l[b] = C;
                        ...
                        for (var r = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                                    ...
                                    C = f[b] ? f[b] : q;
                                    f[b] = n
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = n + ("undefined" !== typeof z[b] ? z[b] : 0), C = a.axisY.convertValueToPixel(z[b]), n = l[b] ? l[b] : q, l[b] = C;
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() :
                                ...
                                var A = n - a.plotType.plotUnits.length * g / 2 + a.index * g << 0,
                                    J = A + g << 0,
                                    C;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) u[b] = t[h].y + (u[b] ? u[b] : 0), 0 < u[b] && (C = f[b] ? f[b] : q, f[b] = p = a.axisY.convertValueToPixel(u[b]));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) z[b] = t[h].y + (z[b] ? z[b] : 0), p = l[b] ?
                                    l[b] : q, l[b] = C = a.axisY.convertValueToPixel(z[b]);
                        ...
                        for (h = 0; h < t.length; h++)
                            if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                                    ...
                                    q, l[b] = A = a.axisY.convertValueToPixel(z[b]);
        ...
        m.prototype.renderArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    d = !0;
                    var k = 0,
                        m, t, r, A = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        J, C = null;
                    if (0 < B.length) {
                        ...
                        for (var ha = !0; k < B.length; k++)
                            if (r = B[k].x.getTime ? B[k].x.getTime() : B[k].x, !(r < a.axisX.dataInfo.viewPortMin ||
                                    r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ha)))
        ...
        m.prototype.renderSplineArea = function(a) {
                ...
                if (0 < c.length) {
                    if (0 < p.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3)
                            if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), s && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    var l = [],
                        q = 0,
                        g, B, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                        m, t = null,
                        r = [];
                    if (0 < n.length) {
                        ...
                        for (B = !1; q < n.length; q++)
                            if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !B)))
                                if ("number" !== typeof n[q].y) 0 < q && !B && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = w,
                                    y = p.nullDataLineDashType) : (d(), r = [])), B = !0;
                                else {
        ...
        m.prototype.renderStepArea = function(a) {
            ...
            function b() {
                C && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = A : 0 > a.axisY.viewportMaximum ? J = u.y1 : 0 < a.axisY.viewportMinimum && (J = A), f.lineTo(m, J), f.lineTo(C.x, J), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, s && (l.lineTo(m, J), l.lineTo(C.x, J), l.closePath(), l.fill()),
                    f.beginPath(), f.moveTo(m, t), l.beginPath(), l.moveTo(m, t), C = {
                        x: m,
                        y: t
                    })
            }
        ...
        m.prototype.renderBubble = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var u = -Infinity, k = Infinity, h = 0; h < a.dataSeriesIndexes.length; h++)
                    for (var p = a.dataSeriesIndexes[h], n = this.data[p], q = n.dataPoints, g = 0, e = 0; e < q.length; e++) f = q[e].getTime ? f = q[e].x.getTime() : f = q[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax ||
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < p.length) {
                        ...
                        for (var n = 0, q = 0, e = 0; e < p.length; e++)
                            if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin ||
                    ...
                    for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                        ...
                        if (0 < x.length)
                            for (var A = 5 < m && t.bevelEnabled ? !0 : !1, u = 0; u < x.length; u++)
                                if (x[u].getTime ? g = x[u].x.getTime() : g = x[u].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[u].y) && x[u].y.length && "number" === typeof x[u].y[0] && "number" === typeof x[u].y[1] && "number" === typeof x[u].y[2] && "number" === typeof x[u].y[3]) {
                ...
                for (var ga = !1, ga = !!a.axisY.reversed, O = 0; O < a.dataSeriesIndexes.length; O++) {
                    ...
                    if (0 < A.length)
                        for (var v = 5 < m && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (A[l].getTime ? g = A[l].x.getTime() : g = A[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
        ...
        m.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    l, u, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var A = a.dataSeriesIndexes[x],
                        ...
                        D = 0;
                    if (y)
                        for (e = v._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) &&
                ...
                for (var u = 0; u < a.dataSeriesIndexes.length; u++) {
                    ...
                    if (0 < n.length) {
                        ...
                        for (var K = !0; g < n.length; g++)
                            if (t = n[g].x.getTime ?
                                n[g].x.getTime() : n[g].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !K)))
                    ...
                    if (0 < p.length) {
                        ...
                        for (g = !1; n < p.length; n++)
                            if (q = p[n].x.getTime ? p[n].x.getTime() : p[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !g)))
                                if (null !== p[n].y && p[n].y.length && "number" === typeof p[n].y[0] && "number" ===
                                    typeof p[n].y[1]) {
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== h.indexLabelPlacement) {
                        ...
                        for (a = 0; a < p.length; a++) k = g[a], s = "pie" === h.type ? 0.7 * y : 0.8 * y, r = A.x + s * Math.cos(k.midAngle),
                                ...
                                if (null !== l) {
                                    ...
                                    if (m = 0 > C) {
                                        ...
                                        var q = u.indexLabelTextBlock.y - u.indexLabelTextBlock.height / 2,
                                            ...
                                            z = k.indexLabelTextBlock.x + k.indexLabelTextBlock.width,
                                            B = k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2;
                                        m = u.indexLabelTextBlock.x +
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function e() {
                ...
                if (e)
                    for (l = H.length - 1; 0 <= l; l--) a = R[l], H[l].textBlock.maxWidth = f[f.length - (l + 1)], H[l].textBlock.measureText(), H[l].textBlock.x = N - h, c = H[l].textBlock.height < H[l].textBlock.maxHeight ? H[l].textBlock.height : H[l].textBlock.maxHeight, e = H[l].textBlock.width < H[l].textBlock.maxWidth ?
            ...
            function f() {
                ...
                if ("inside" !== t.indexLabelPlacement)
                    for (var e = 0; e < R.length; e++) 0 == H[e].textBlock.text.length ?
            ...
            function l() {
                ...
                function c(a, b, d) {
                    ...
                    for (d = 0; d < e.length; d++)
                        if (b =
                            e[d], f < a) g++, f += H[b.id].height + ea, H[b.id].textBlock.text = "", H[b.id].indexLabelText = "", H[b.id].isDirty = !0, H[b.id].textBlock.measureText();
                        else break;
                    return g
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var t = this.data[a.dataSeriesIndexes[0]],
                        x = t.dataPoints, A = this.plotArea, D = 0.025 * A.width, C = 0.01 * A.width, y = 0, E = A.height - 2 * D, G = Math.min(A.width - 2 * C, 2.8 * A.height), K = !1, P = 0; P < x.length; P++)
                    if (!K && ("undefined" !== typeof x[P].indexLabel && null !== x[P].indexLabel && 0 < x[P].indexLabel.toString().length) && (K = !0), !K && ("undefined" !== typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (K = !0), !K && "function" === typeof t.indexLabelFormatter || "function" === typeof x[P].indexLabelFormatter) K = !0;
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== P) {
                        ...
                        if (t.reversed)
                            for (F =
                                0; F < P.length; F++) G[F] < xa ? (a.push(M), C.push(Y), da = F) : (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa));
                        else
                            for (F = 0; F < P.length; F++) G[F] < xa ? (a.push((G[F] - U + ba * X) / ba), C.push((G[F] - U + fa * aa) / fa), da = F) : (a.push(M), C.push(Y));
        ...
        m.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                else return "y" === a ? fa(g, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" ===
        ...
        E.prototype.setLayout = function() {
                ...
                if (n.dataPoints && n.dataPoints.length)
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? "error" === n.type && n._linkedSeries ? n._linkedSeries.legendMarkerType ? n._linkedSeries.legendMarkerType : G.getDefaultLegendMarker(n._linkedSeries.type) : G.getDefaultLegendMarker(n.type) : n.markerType,
                            ...
                            t = n.legendMarkerBorderThickness ? n.legendMarkerBorderThickness :
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var A = n.dataPoints[x],
                                q = A.legendMarkerType ? A.legendMarkerType : n.legendMarkerType ? n.legendMarkerType :
                                G.getDefaultLegendMarker(n.type),
                                g = A.legendText ? A.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({
                                    chart: this.chart,
                                    legend: this.options,
                                    dataSeries: n,
                                    dataPoint: A
                                ...
                                v = A.legendMarkerBorderColor ? A.legendMarkerBorderColor : n.legendMarkerBorderColor ? n.legendMarkerBorderColor :
            ...
            if (0 < m.length) {
                ...
                for (p = 0; p < m.length; p++) {
                    ...
                    if (!(0 >= l || "undefined" ===
                        ...
                        q.textBlock.y = 0;
                        n.width += Math.round(q.textBlock.width + s + k + (0 === n.width ?
            ...
            this.items = m;
            for (p = 0; p < this.items.length; p++) q = m[p], q.id = ++this.chart._eventManager.lastObjectId,
            ...
            for (;;) {
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    var b = this.dataPoints[f],
                        n = this.axisX.logarithmic ? b.x > a ? b.x / a : a / b.x :
                        Math.abs(b.x - a);
        ...
        G.prototype.getDataPointAtXY = function(a, d, c) {
            ...
            if ("none" !== this.chart.plotInfo.axisPlacement)
                ...
                else q = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, n = 0 < q ? Math.min(Math.max((this.dataPoints.length -
                    1) / q * (n - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
            for (;;) {
                f = 0 < l ? n + e : n - e;
                if (0 <= f && f < this.dataPoints.length) {
        ...
        D.prototype.createLabels = function() {
            ...
            if ("bottom" === this._position || "top" === this._position) k = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.width * Math.log(Math.min(this._labels[this._labels.length - 1].position / this._labels[this._labels.length - 2].position, this._labels[1].position / this._labels[0].position)) / Math.log(this.range) : this.lineCoordinates.width / (this.logarithmic && this.equidistantInterval ? Math.log(this.range) / Math.log(this.logarithmBase) : Math.abs(this.range)) *
                T[this.intervalType + "Duration"] * this.interval, f = "undefined" === typeof this.options.labelMaxWidth ? 0.5 * this.chart.width >> 0 : this.options.labelMaxWidth, this.chart.panEnabled || (l = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.8 * this.chart.height >> 0 : 1.5 * this.labelFontSize);
            else if ("left" === this._position || "right" === this._position) k = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length - 1].position /
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                if (r(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                    if (f = 0.9 * k >> 0, q = 0, !this.chart.panEnabled && 1 <=
                        this._labels.length) {
                                ...
                                if (r(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? l : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), p = (h - (m + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !r(this.options.labelWrap)) this.labelWrap ? r(this.options.labelMaxWidth) ?
                                        ...
                                        if (r(this.options.labelWrap))
                                            ...
                                            if (b = B.width + d.width >> 0, g = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, r(this.options.labelFontSize) && 12 < g && (g = Math.floor(12 / 13 * g), a.measureText()), this.sessionVariables.labelFontSize = r(this.options.labelFontSize) ?
        ...
        D.setLayout = function(a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks &&
                    ...
                    for (var B = q[g].scaleBreaks._appliedBreaks, s = 0; s < B.length && !(B[s].startValue > q[g].viewportMaximum); s++) B[s].endValue < q[g].viewportMinimum || (r(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = s), B[s].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = s));
            ...
            if ("normal" === e) {
                for (var x = [], w = [], D = [], C = [], N = [], Q = [], S = [], T = []; 4 >
                    ...
                    S.push(D);
                    if (b && 0 < b.length)
                        for (C = [], g = ba = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateWidth() : 0)), ba += C[g], aa += b[g] ? b[g].margin : 0;
                    ...
                    if (0 < s) {
                        if (a && 0 < a.length)
                            for (g = 0; g < a.length; g++) B = N[s - 1][g] === N[s][g] ? !0 : !1;
                        else B = !0;
                        if (d && 0 < d.length)
                ...
                for (Q = []; 4 > s;) {
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++) b[g].lineCoordinates = {}, l = Math.round(f.x1 + X + e), m = Math.round(f.x2 - V - Z > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - V - Z), b[g] && b[g].labelAutoFit && !r(D) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, D) : 0 === b[g].labelAngle ? Math.max(l, D / 2) : l), 0 < !d.length && (m -= C / 2)), b[g].lineCoordinates.x1 = l, b[g].lineCoordinates.x2 = m, b[g].lineCoordinates.width = Math.abs(m - l), b[g].title && (b[g]._titleTextBlock.maxWidth =
        ...
        V.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                            k = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, k = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b - n / 2,
                            y1: e,
                            x2: l + n / 2,
                            y2: k
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("rangeBar" === p[0].dataSeries.type || "error" === p[0].dataSeries.type)
                        ...
                        for (var v =
                                Math.abs(a - this.parent.convertValueToPixel(p[0].dataPoint.y)), E = A = t = 0, s = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                                for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(a - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s);
                            else A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(a - this.parent.convertValueToPixel(E)), t < v && (v = t, w = s);
                    else
                    ...
                    if ("rangeColumn" === p[0].dataSeries.type || "rangeArea" === p[0].dataSeries.type || "error" === p[0].dataSeries.type || "rangeSplineArea" === p[0].dataSeries.type || "candlestick" === p[0].dataSeries.type || "ohlc" === p[0].dataSeries.type || "boxAndWhisker" === p[0].dataSeries.type)
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y[0])),
                            s = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = A = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                                for (x = 0; x <
                                    p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])), t < v && (v = t, w = s);
                        ...
                        for (v = Math.abs(d - this.parent.convertValueToPixel(p[0].dataPoint.y)), s = E = A = t = 0; s < p.length; s++)
                            if (p[s].dataPoint.y && p[s].dataPoint.y.length)
                                for (x = 0; x < p[s].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(p[s].dataPoint.y[x])),
                                    t < v && (v = t, w = s);
                            else A += p[s].dataPoint.y, E = p[s].dataPoint.x.getTime ? p[s].dataPoint.x.getTime() : p[s].dataPoint.x, E = 100 * (A / p[s].dataSeries.plotUnit.dataPointYSums[E]), t = Math.abs(d - this.parent.convertValueToPixel(E)), t < v && (v = t, w = s);
                    else
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (this.parent.labels)
                            ...
                            if ("axisX" === this.parent.type)
                                for (s = this.parent.convertPixelToValue({
                                        y: d
                                    }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(s, !0)) && 0 <= v.index &&
                                    (h.text = this.labelFormatter ? this.labelFormatter({
                                        chart: this.chart,
                                        axis: this.parent.options,
                                        crosshair: this.options,
                    ...
                    if (this.parent.labels)
                        for (p = Math.ceil(this.parent.interval),
                            s = 0; s < this.parent.viewportMaximum; s += p)
                            if (this.parent.labels[s]) E = !0;
                            else {
                                E = !1;
                                break
        ...
        aa.prototype.getToolTipInnerHTML = function(a) {
            ...
            for (var d = null, c = null, b = null, e = 0, f = "", l = !0, k = 0; k < a.length; k++)
                if (a[k].dataSeries.toolTipContent ||
