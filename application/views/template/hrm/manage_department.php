			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Department information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input name="department_name" value="<?php if(!empty($edit)){ echo $edit->department_name; } ?>" type="text" class="form-control" placeholder="Role Title" required>
								</div>
								<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						...
						<div class="card-body">
							<table class="table table-sm" id="dipartment_table">
								<thead>
									<tr>
										<th></th>
										<th>Move</th>
...
$('document').ready(function(){ 
	$( "#page_list" ).sortable({
		...
		update		: function(event, ui)
		{
			...
			$.ajax({
				url:"<?php echo base_url(); ?>/assets/ajax/option_select/short_department_order_list_option_select.php",
				method:"POST",
