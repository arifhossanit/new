<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Transfer Money</h1>
				</div> 
				<div class="col-sm-6">
			...
			<div class="row">							
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											...
											<input type="text" name="transfer_emp_id" class="number_int form-control" placeholder="Employee ID" autocomplete="off" required />
										</div>
									</div>									
									<div class="col-sm-12">
										<div class="form-group">
									...
									<div class="col-sm-12">
										<div class="form-group">
											<button name="send_request" type="submit" class="btn btn-success" style="float:right;">Send Balance</button>
										</div>
									</div>
								</div>
							</form>		
				...
				<div class="col-sm-9" style="padding-top:20px;">
					<div class="card card-warning">
						<div class="card-header">
							<h3 class="card-title">My Transfered List</h3>
...
$(document).ready(function(){
	...
	var table_data = '?employee_id='+employee_id+'';
    var table = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/hrm/employee_wallet_money_transfer_list.php"+table_data,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
