...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Generate Visiting Card</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
					<li class="breadcrumb-item active">Generate Visiting Card</li>
					</ol>
				</div> 
			</div> 
		</div> 
			...
			<div class="row">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Visiting Cards</h3>
						</div>
...
$('#generate_card').on('submit', function(){
	...
	$.ajax({
		type: 'post',
		url:"<?=base_url('assets/ajax/data_table/employee_visiting_card_from_profile_multiple.php');?>",
