...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Fingure Missing Reason</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">Fingure Missing Reason</li>
            </ol>
          </div> 
        </div> 
      </div> 
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Reason information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input name="reason_name" value="<?php if(!empty($edit)){ echo $edit->reason_name; } ?>" type="text" class="form-control" placeholder="Reason Name" required>
								</div>
								<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						...
						<div class="card-body">
							<table class="table table-sm" id="example2c">
								<thead>
									<tr>
										<th></th>
										<th>Move</th>
...
$(document).ready(function(){ 
	$( "#page_list" ).sortable({
		...
		update		: function(event, ui)
		{
			...
			$.ajax({
				url:"<?php echo base_url(); ?>/assets/ajax/option_select/short_grade_order_list_option_select.php",
				method:"POST",
