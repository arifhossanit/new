				...
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Grade information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input name="grade_name" value="<?php if(!empty($edit)){ echo $edit->grade_name; } ?>" type="text" class="form-control" placeholder="Grade Title" required>
								</div>
								<div class="form-group">
