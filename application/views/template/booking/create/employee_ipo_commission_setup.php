...
<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Employee IPO Commission</h1>
          </div> 
          <div class="col-sm-6">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Write Commission In Percentage</label>
											<input name="commission_percentage" value="<?php if(!empty($edit)){ echo $edit->commission_percentage; } ?>" type="text" class="form-control" required placeholder="Commission Percentage: Ex: 0.1">
										</div>
									</div>
								</div>
