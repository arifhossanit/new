...
<input type="hidden" id="otp_verify_get" value="<?php echo (!empty($bfifpb->otp)) ? '1' : '0';?>"/>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="row">
									...
									<div class="col-sm-4">
										<span id="otp_error_message"><?php echo (!empty($bfifpb->otp)) ? '<a href="#" onclick="resend_otp()">Resend OTP?</a>' : '';?></span>
									</div>
									<div class="col-sm-4">
										<div class="row">
											<div class="col-sm-6"></div>
											<div class="col-sm-6">
												<div class="form-group" id="otp_field_container" <?php echo (empty($bfifpb->otp)) ? 'style="display:none"' : '';?>>
													<input type="text" id="out_otp" name="out_otp" placeholder="OTP: (Ex:XXXX)" class="form-control number_int" value="<?php echo (!empty($bfifpb->otp)) ? $bfifpb->otp : '';?>"/>
													<input type="hidden" id="inner_otp" name="inner_otp" value="<?php echo (!empty($bfifpb->otp)) ? $bfifpb->otp : '';?>"/>
												</div>
											</div>
										</div>
									</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<h4>
									...
									<span style="float:right;font-size:10px;color:#f00;line-height:34px;"><b><?php echo $hm; ?> N:B: Mid Night chheckIn is Disabled, It Enable From 12:00am TO 10:00am</b>&nbsp;&nbsp;</span>
									<?php } ?>
								</h4>
						...
						<div class="row">
							<div class="col-sm-12">
								<div style="width:200px;margin-left:auto;margin-right:auto;">
									<button type="button" class="btn btn-success myButton" data-toggle="modal" data-target="#select-payment-option-image" id="payNowId">
										<img src="http://localhost/super_home/assets/img/pay_now_icon.png" alt="" style="width:150px;">
									</button>
								</div>
								<h4 style="text-decoration:underline;display:none;" id="plusButtonh4Id">									
									<div class="row d-flex" style="float:right;padding-right: 16px;"><!--justify-content-end-->											
										...
										<button type="button" id='addButton_payment' class="btn btn-success btn-xs" style="border-radius:5px;padding-left: 5px;" data-toggle="modal" data-target="#select-payment-option-image"><i class="fas fa-plus-square"></i></button>
									</div>
...
<!-- Confirm without card modal -->
<div class="modal fade" role="dialog" id="confirm_wo_card">
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12 text-center">
						<p class="text-danger" style="font-size: 40px;"><span><i class="fas fa-skull-crossbones"></i></span><span class="ml-1">To Confirm Booking Without Card Number Submit Again!!</span></p>
					</div>
				</div>
			</div>
...
<div class="modal fade" role="dialog" id="select-payment-option-image" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog modal-lg modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-body">
				<h3 style="text-align:center;font-weight:700;color:red;">Select A Payment Method</h3>
				<div class="row">
					<div class="col-md-6 text-center icon_div" id="paymentDivOptionOne">
						<button type="button" onclick="function hi(){

						var GetValueOfInputFieldSetAsNumber  =  document.getElementById('toStoreHowManyOption').value;
						var getLastSelectOptionValue = document.getElementById('payment_method1').value;
						if(getLastSelectOptionValue == '' && GetValueOfInputFieldSetAsNumber == 0){
							document.getElementById('toStoreHowManyOption').value = 1;
							document.getElementById('payment_method1').getElementsByTagName('option')[2].selected = 'selected';
							document.getElementById('paymentDivOptionOne').style.display = 'none';
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(1);
							document.getElementById('payment_method1').remove(1);
							
							document.getElementById('payNowId').style.display = 'none';
							document.getElementById('paymentMethodOptionSelectOne').style.display = 'block';
							document.getElementById('plusButtonh4Id').style.display = 'block';
							payment_function_on_change();
							return false;
						}

							if(getLastSelectOptionValue != null && GetValueOfInputFieldSetAsNumber == 1 ){
								document.getElementById('toStoreHowManyOption').value = 2;
								document.getElementById('payment_method12').getElementsByTagName('option')[2].selected = 'selected';
								document.getElementById('paymentDivOptionOne').style.display = 'none';
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(1);
								document.getElementById('payment_method12').remove(1);
								payment_function_on_change();
								return false;
							}

							var getLastSelectOptionValueOne = document.getElementById('payment_method12').value;
							if(getLastSelectOptionValueOne != null && GetValueOfInputFieldSetAsNumber == 2){
								document.getElementById('toStoreHowManyOption').value = 3;
								document.getElementById('payment_method13').getElementsByTagName('option')[2].selected = 'selected';
								document.getElementById('paymentDivOptionOne').style.display = 'none';
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(1);
								document.getElementById('payment_method13').remove(1);
								payment_function_on_change();
								return false;
							}
							...
							hi();" data-dismiss="modal">
							<img src="<?=base_url(); ?>assets/img/online_booking_icon.jpg" alt="" class="payment_icon_image_style">
							<p class="payment_icon_text">Mobile Booking</p>
						</button>
					</div>
					<div class="col-md-6 text-center icon_div" id="paymentDivOptionTwo">
					<button type="button" onclick="function hi(){
							...
							if(getLastSelectOptionValue == '' && GetValueOfInputFieldSetAsNumber == 0){
								document.getElementById('toStoreHowManyOption').value = 1;
								document.getElementById('payment_method1').getElementsByTagName('option')[1].selected = 'selected';
								document.getElementById('paymentDivOptionTwo').style.display = 'none';
								document.getElementById('payment_method1').remove(0);
								document.getElementById('payment_method1').remove(1);
								document.getElementById('payment_method1').remove(1);
								document.getElementById('payment_method1').remove(1);
							...
							if(getLastSelectOptionValue != null && GetValueOfInputFieldSetAsNumber == 1){
								document.getElementById('toStoreHowManyOption').value = 2;
								document.getElementById('payment_method12').getElementsByTagName('option')[1].selected = 'selected';
								document.getElementById('paymentDivOptionTwo').style.display = 'none';
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(1);
								document.getElementById('payment_method12').remove(1);
							...
							if(getLastSelectOptionValueOne != null && GetValueOfInputFieldSetAsNumber == 2){
								document.getElementById('toStoreHowManyOption').value = 3;
								document.getElementById('payment_method13').getElementsByTagName('option')[1].selected = 'selected';
								document.getElementById('paymentDivOptionOne').style.display = 'none';
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(1);
								document.getElementById('payment_method13').remove(1);
							...
							hi();" data-dismiss="modal">
							<img src="<?=base_url(); ?>assets/img/cash_icon.png" alt="" class="payment_icon_image_style">
							<p class="payment_icon_text">Cash Payment</p>
						</button>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6 text-center icon_div" id="paymentDivOptionThree">
					<button type="button" onclick="function hi(){
					...
					if(getLastSelectOptionValue == '' && GetValueOfInputFieldSetAsNumber == 0){
							document.getElementById('crd_add_sudm').innerHTML = '(CP: 2%)';
							document.getElementById('toStoreHowManyOption').value = 1;
							document.getElementById('payment_method1').getElementsByTagName('option')[3].selected = 'selected';
							document.getElementById('paymentDivOptionThree').style.display = 'none';
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(1);
							...
							if(getLastSelectOptionValue != null && GetValueOfInputFieldSetAsNumber == 1){
								document.getElementById('crd_add_sudm').innerHTML = '(CP: 2%)';
								document.getElementById('toStoreHowManyOption').value = 2;
								document.getElementById('payment_method12').getElementsByTagName('option')[3].selected = 'selected';
								document.getElementById('paymentDivOptionThree').style.display = 'none';
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(0);
							...
							if(getLastSelectOptionValueOne != null && GetValueOfInputFieldSetAsNumber == 2){
								document.getElementById('crd_add_sudm').innerHTML = '(CP: 2%)';
								document.getElementById('toStoreHowManyOption').value = 3;
								document.getElementById('payment_method13').getElementsByTagName('option')[3].selected = 'selected';
								document.getElementById('paymentDivOptionThree').style.display = 'none';
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(0);
							...
							hi();" data-dismiss="modal">
							<img src="<?=base_url(); ?>assets/img/debit_card_icon.jpg" alt="" class="payment_icon_image_style">
							<p class="payment_icon_text">Credit / Debit Card</p>
						</button>
					</div>
					<div class="col-md-6 text-center icon_div" id="paymentDivOptionFour">
					<button type="button" onclick="function hi(){
						var GetValueOfInputFieldSetAsNumber  =  document.getElementById('toStoreHowManyOption').value;
						var getLastSelectOptionValue = document.getElementById('payment_method1').value;
						...
						if(getLastSelectOptionValue == '' && GetValueOfInputFieldSetAsNumber == 0){
							document.getElementById('toStoreHowManyOption').value = 1;
							document.getElementById('payment_method1').getElementsByTagName('option')[4].selected = 'selected';
							document.getElementById('paymentDivOptionFour').style.display = 'none';
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							document.getElementById('payment_method1').remove(0);
							...
							if(getLastSelectOptionValue != null && GetValueOfInputFieldSetAsNumber == 1){
								document.getElementById('toStoreHowManyOption').value = 2;
								document.getElementById('payment_method12').getElementsByTagName('option')[4].selected = 'selected';
								document.getElementById('paymentDivOptionFour').style.display = 'none';
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(0);
								document.getElementById('payment_method12').remove(0);
							...
							if(getLastSelectOptionValueOne != null && GetValueOfInputFieldSetAsNumber == 2){
								document.getElementById('toStoreHowManyOption').value = 3;
								document.getElementById('payment_method13').getElementsByTagName('option')[4].selected = 'selected';
								document.getElementById('paymentDivOptionFour').style.display = 'none';
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(0);
								document.getElementById('payment_method13').remove(0);
							...
							hi();" data-dismiss="modal">
							<img src="<?=base_url(); ?>assets/img/chaque.jpg" alt="" class="payment_icon_image_style">
							<p class="payment_icon_text">Cheque Payment</p>
						</button>
					</div>
				</div>
			</div>
...
$(document).ready(function(){
    ...
    $("#removeButton_payment").click(function () {
		if( counter_payment != 2 ){
			var GetValueofSetToTrace = document.getElementById('toStoreHowManyOption').value;
			if(GetValueofSetToTrace == 1){
				document.getElementById('toStoreHowManyOption').value = 0;
				var valueofOptionFirstDiv = document.getElementById('payment_method1').value;
				if(valueofOptionFirstDiv == 'Mobile Banking'){
					document.getElementById('paymentDivOptionOne').style.display = 'block';
				}if(valueofOptionFirstDiv == 'Cash'){
					document.getElementById('paymentDivOptionTwo').style.display = 'block';
				}if(valueofOptionFirstDiv == 'Credit / Debit Card'){
					document.getElementById('paymentDivOptionThree').style.display = 'block';
					document.getElementById('crd_add_sudm').innerHTML = '';
				}if(valueofOptionFirstDiv == 'Check'){
					document.getElementById('paymentDivOptionFour').style.display = 'block';
				}
			}
			if(GetValueofSetToTrace == 2){
				document.getElementById('toStoreHowManyOption').value = 1;
				var valueofOptionFirstDiv = document.getElementById('payment_method12').value;
				if(valueofOptionFirstDiv == 'Mobile Banking'){
					document.getElementById('paymentDivOptionOne').style.display = 'block';
				}if(valueofOptionFirstDiv == 'Cash'){
					document.getElementById('paymentDivOptionTwo').style.display = 'block';
			...
			if(GetValueofSetToTrace == 3){
				document.getElementById('toStoreHowManyOption').value = 2;
				var valueofOptionFirstDiv = document.getElementById('payment_method13').value;
				if(valueofOptionFirstDiv == 'Mobile Banking'){
					document.getElementById('paymentDivOptionOne').style.display = 'block';
				}if(valueofOptionFirstDiv == 'Cash'){
					document.getElementById('paymentDivOptionTwo').style.display = 'block';
		...
		if( counter_payment == 2 ){
			...
			//document.getElementById('payment_method1').getElementsByTagName('option')[0].selected = 'selected';
			//document.getElementById('UnitBoxDiv_payment1').style.display = 'none';
			return false;
		}
