<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Force Cancel Report</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Report</a></li>
              <li class="breadcrumb-item active">Force Cancel Report</li>
            </ol>
          </div> 
        </div> 
      </div> 
						...
						<div class="col-sm-12">
							<div class="card card-dark">
								<div class="card-header">
									<div class="row">
										<div class="col-sm-3">
											<h3 class="card-title"><i class="far fa-bed"></i> Force Cancel Report</h3>									
										</div>
										<div class="col-sm-2">
...
function booking_report_table(){
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/force_cancel_report_datatable.php'+condition;
...
$('document').ready(function(){	
	...
	var table_booking = $('#booking_data_table').DataTable({
        ...
        "serverSide": true,
		"scrollX": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/force_cancel_report_datatable.php"+condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
