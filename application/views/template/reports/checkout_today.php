<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">CheckOut Today Report</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">CheckOut Today Report</li>
            </ol>
          </div> 
        </div> 
      </div> 
						...
						<div class="col-sm-12">
							<div class="card card-success">
								<div class="card-header">
									<div class="row">
										<div class="col-sm-3">
											<h3 class="card-title"><i class="far fa-bed"></i>CheckOut Today Report</h3>									
										</div>
										<div class="col-sm-2">
											...
											<input type="hidden" id="branch_id_hrad" value="<?php echo rahat_encode($_SESSION['super_admin']['branch']); ?>"/>
											<?php } ?>
										</div>
										<div class="col-sm-7">
													...
													<div class="row">
														...
														<div class="col-sm-6">
															<div class="form-group">
																...
																<input type="date" name="date_short" id="date_short" class="form-control" value="<?php echo date('Y-m-d'); ?>"/>
															</div>
														</div>
													</div>													
												</div>
...
$('document').ready(function(){	
	$("#date_short").on("change keyup keydown",function(){
		return booking_report_table();
	})
	//return booking_report_table();
})
function booking_report_table(){
	...
	var other = 'date_short='+$("#date_short").val()+'&occupation='+$("#occupation").val()+'&religion='+$("#religion").val()+'&h_t_f_u='+$("#h_t_f_u").val()+'&package_category='+$("#package_category").val()+'&package='+$("#package").val()+'&parking='+$("#parking").val()+'&authorization='+$("#authorization").val()+'';
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/checkout_today_report_datatable.php'+condition;
...
$('document').ready(function(){
	...
	var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/checkout_today_report_datatable.php"+condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
