<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Auto SMS Logs</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Auto SMS Logs</li>
					</ol>
				</div> 
			</div> 
		</div> 
				...
				<div class="col-sm-12">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Auto SMS Logs</h3>
...
$('document').ready(function(){
	var table = $('#candidate_list').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/communication/auto_sms_logs_report_datatable_data.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
