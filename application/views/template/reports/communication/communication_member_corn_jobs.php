<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Member Corn Job Logs</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Member Corn Job Logs</li>
					</ol>
				</div> 
			</div> 
		</div> 
		...
		<div class="container">
			<div class="row">	
				<div class="col-sm-12">
					...
					$check_data = $this->Dashboard_model->mysqlii("select  * from corn_jobs_log where reason = 'Member Available Date Manage & Rental Issue' and data = '".$today."' order by id desc");
					if(empty($check_data[0]->id)){
					?>
					<button onclick="window.open('<?php echo base_url('assets/corn_jobs/member_available_days.php'); ?>','_blank')"  style="float:right;margin-bottom:15px;" class="btn btn-success" type="button">Run Corn job for - <?php echo $today; ?> Member Available Days</button>
					<?php } ?>
				</div>
				<div class="col-sm-12">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Member Corn Job Logs</h3>
...
$('document').ready(function(){
	var table = $('#candidate_list').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/communication/member_corn_job_logs_report_datatable_data.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
