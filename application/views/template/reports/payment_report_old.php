										...
										<div class="tab-pane fade <?php if(empty($mis_act)){ echo  'show active'; } ?>" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
											<div class="card card-success">
												...
												<div class="card-body">	<!--display: contents;-->								
													<!-- <style>#booking_data_table_wrapper{overflow-x:scroll;} #booking_data_table td{text-align:center;vertical-align: middle;white-space: pre;}#booking_data_table th{text-align:center;vertical-align: middle;}#booking_data_table td:last-child{text-align:left;}</style> -->
...
$('document').ready(function(){
	...
	var table_booking3 = $('#collection_money_from_dropbox').DataTable({
		"paging": true,
		"lengthChange": true,
		"searching": true,
		"ordering": true,
	 ...
	 table_booking3.buttons().container().appendTo($('#export_buttons_dropbox_collection'));
})
</script>
