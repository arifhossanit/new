<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Employee Login Activity</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Employee Login Activity</li>
					</ol>
				</div> 
			</div> 
		</div> 
...
function view_data(view_id){				
	if(view_id != ''){
		$.ajax({  
			url:"<?=base_url('assets/ajax/form_model/view_login_information.php');?>",  
			method:"POST",  
...
$('document').ready(function(){
	var table = $('#candidate_list').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/tracing_report/tracing_report_all_employee_login.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
