<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Employee Activity Screenshot</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Employee Activity Screenshot</li>
					</ol>
				</div> 
			</div> 
		</div> 
				...
				<div class="col-sm-12">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Employee Activity Screenshot</h3>
...
<!----End vaiw model-->
<script>
function view_full_sms(id){
	var sms_id = id;				
	if(sms_id != ''){
		$.ajax({  
			url:"<?=base_url('assets/ajax/form_model/view_sms_information.php');?>",  
			method:"POST",  
			data:{sms_id:sms_id},
			beforeSend:function(){					
...
$('document').ready(function(){
	var table = $('#candidate_list').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/tracing_report/tracing_report_all_employee_secreenshot.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
