<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Renew Report</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">Renew Report</li>
            </ol>
          </div> 
        </div> 
      </div> 
						...
						<div class="col-sm-12">
							<div class="card card-info">
								<div class="card-header">
									<div class="row">
										<div class="col-sm-3">
											<h3 class="card-title"><i class="far fa-bed"></i> Renew Report</h3>									
										</div>
										<div class="col-sm-2">
...
function booking_report_table(){
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/renew_report_datatable.php'+condition;
...
$('document').ready(function(){
	...
	var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/renew_report_datatable.php"+condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
