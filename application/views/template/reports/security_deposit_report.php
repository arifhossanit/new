...
function booking_report_table(){
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/security_deposit_report_datatable.php'+filter;
...
$('document').ready(function(){
	...
	var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": false,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/security_deposit_report_datatable.php"+filter,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
