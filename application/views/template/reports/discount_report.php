<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Discount Report</h1>
          </div> 
          <div class="col-sm-6">
						...
						<div class="col-sm-12">
							<div class="card card-success">
								<div class="card-header">
									<h3 class="card-title"><i class="far fa-bed"></i> Discount Report</h3>
...
function booking_report_table(){
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/discount_report_datatable.php'+condition;
...
$('document').ready(function(){
	...
	var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/discount_report_datatable.php"+condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
