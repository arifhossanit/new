<div class="content-wrapper">
	<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Occupide Member List Report</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Report</a></li>
              <li class="breadcrumb-item active">Occupide Member List</li>
            </ol>
          </div> 
        </div> 
      </div> 
						...
						<div class="col-sm-12">
							<div class="card card-success">
								<div class="card-header">
									<h3 class="card-title"><i class="far fa-bed"></i>Occupide Member List Report</h3>
...
function booking_report_table(){
	...
	var ajax_data = '<?=base_url(); ?>assets/ajax/data_table/report/occupide_member_list_report_datatable.php'+condition;
...
$('document').ready(function(){	
	...
	var table_booking = $('#booking_data_table').DataTable({
        ...
        "serverSide": true,
		"scrollX": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/report/occupide_member_list_report_datatable.php"+condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
