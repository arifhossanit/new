...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SMS Purpase</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">SMS Purpase</li>
            </ol>
          </div> 
        </div> 
      </div> 
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input SMS Purpase</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="form-group">
									<label>Purpase Name</label>
									<input name="purpuse_name" value="<?php if(!empty($edit)){ echo $edit->purpuse_name; } ?>" type="text" class="form-control" placeholder="Purpase Name" required>
								</div>								
								<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Purpase List</h3>
						</div>
						<div class="card-body">
