				...
				<div class="col-sm-3">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Rooms information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<select id="package_category" name="package_category" class="form-control select2" required> </select>
								</div>
								<div class="form-group">
									<label>Bed Type</label>
									<select id="room_type" name="room_type" class="form-control select2" required> </select>
								</div>
								<div class="form-group">
									<label>Room Name</label>
									<input name="room_name" value="<?php if(!empty($edit)){ echo $edit->room_name; } ?>" type="text" class="form-control" placeholder="Floor Name" required>
								</div>								
								<div class="form-group">
									<label>Note</label>
