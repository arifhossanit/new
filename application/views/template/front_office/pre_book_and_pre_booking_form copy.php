					...
					<div class="card-body">
						<form id="pre_booking_form" action="<?php echo current_url(); ?>" method="post" enctype="multipart/fform-data">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" id="phone" autocomplete="off" name="phone" minlength="11" maxlength="11" class="number_int form-control" placeholder="E.x 01000000000" required />
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" id="" autocomplete="off" name="emergency_contact_name" class="form-control" placeholder="Emergency Contact name" required />
									</div>
								</div>
							...
							<div class="form-group" id="submit_button" style="display:none;">								
								<button type="submit" id="save" name="save" class="btn btn-success" style="float:right;"><i class="fas fa-chalkboard-teacher"></i>  &nbsp;&nbsp;&nbsp;Apply</button>								
							</div>
			...
			$.ajax({
				...
				success:function(data){
					...
					if(value[1] == 1){
						...
						$("#done_message").html(value[0]+ '<span style="color:#f00;">(Page will be refresh after 5 sec.)</span>');
						setTimeout(function () {
