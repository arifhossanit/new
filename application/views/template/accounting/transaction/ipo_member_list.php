...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">IPO widrawral List</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">IPO widrawral List</li>
            </ol>
          </div> 
        </div> 
      </div> 
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-12">
							<div class="row">
								<div class="col-sm-12">
									<a href="<?php echo base_url('admin/accounting/transaction/ipo-member-widdraw-list'); ?>" class="btn btn-dark" style="margin-bottom:15px;float:right;">Approved Widthdraw List</a>
								</div>
							</div>
							<span id="data_send_success_message"></span>
							<div class="card card-dark">
								<div class="card-header">
									<h3 class="card-title">IPO widrawral Directory</h3>
...
$('document').ready(function(){
	$("#sicuriey_deposit_submit").on("submit",function(){
		...
		$.ajax({
			...
			url:"<?=base_url('assets/ajax/ipo/widthdraw_request_submit_form_account.php');?>",  
			data: data,
			processData: false,
			contentType: false,
			cache: false,
...
function view_member_profile(id){
	...
	if(profile_id != ''){
		$.ajax({  
			url:"<?=base_url('assets/ajax/ipo/return_widthdraw_money_form.php');?>",  
			method:"POST",  
...
$(document).ready(function() {
	var table = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/ipo/accounting_ipo_widthdraw_member_list_datatable.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
