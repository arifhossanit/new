...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Employee Aproved Widthlist List</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Employee Aproved Widthlist List</li>
            </ol>
          </div> 
        </div> 
      </div> 
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="row">
								<div class="col-sm-12">
									<a href="<?php echo base_url('admin/accounting/transaction/employee-widthdraw-list'); ?>" class="btn btn-info" style="margin-bottom:15px;float:right;">Back</a>
								</div>
							</div>
							...
							<div class="card card-info">
								<div class="card-header">
									<h3 class="card-title">Employee Aproved Widthlist Directory</h3>
...
function view_member_profile(id){
	...
	if(profile_id != ''){
		$.ajax({  
			url:"<?=base_url('assets/ajax/accounting/employee_widthdraw_details_money_form.php');?>",  
			method:"POST",  
...
$(document).ready(function() {
	var table = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/hrm/accounting_employee_approved_widthdraw_member_list_datatable.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
