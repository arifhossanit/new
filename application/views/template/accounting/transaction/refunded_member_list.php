...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Refunded Member List</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Refunded Member List</li>
            </ol>
          </div> 
        </div> 
      </div> 
				...
				<div class="col-sm-12">
					<div class="row">
						...
						<!--
							<div class="row">
								<div class="col-sm-12">
									<a href="<?php echo base_url('admin/report/crm-report/checkout-member-list'); ?>" class="btn btn-danger" style="margin-bottom:15px;float:right;">Back to Checkout member list</a>
								</div>
							</div> -->
...
function view_member_profile(id){
	...
	if(profile_id != ''){
		$.ajax({  
			url:"<?=base_url('assets/ajax/form_model/return_refund_details_money_form.php');?>",  
			method:"POST",  
...
$(document).ready(function() {
	...
	var table = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/accounting_refunded_member_list_datatable.php"+table_info,
