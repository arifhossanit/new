...
function filter_data_table(){
	...
	var ajax_data4 = "<?=base_url(); ?>assets/ajax/data_table/view_instant_transaction_buy_something_slip_datatable.php"+condition;
...
$(document).ready(function() {
    ...
    var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/view_instant_transaction_buy_something_slip_datatable.php" + condition,
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
