<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Purses Item From Advance Money With Approval Logs</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
				...
				<li class="breadcrumb-item active">Purses Item From Advance Money With Approval Logs</li>
            </ol>
          </div> 
        </div> 
      </div> 
				...
				<div class="col-sm-12">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title"><i class="far fa-bed"></i> Purses Item From Advance Money With Approval Logs</h3>
...
function filter_data_table(){
	...
	var ajax_data4 = "<?=base_url(); ?>assets/ajax/data_table/view_advanced_approval_transaction_buy_something_datatable.php"+condition;
...
$(document).ready(function() {
    var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/view_advanced_approval_transaction_buy_something_datatable.php",
		dom: 'lBfrtip',
        buttons: [			
            {
                extend: 'copy',
