<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Accounts Advance salary Approval</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Accounts Advance salary Approval</li>
					</ol>
				</div> 
			</div> 
		</div> 
				...
				<div class="col-sm-11">
					<div class="card card-info">
						<div class="card-header">
							<i class="fas fa-paper-plane"></i>Accounts Advance salary Approval Logs
							...
							<div class="row">
								<div class="col-2">
									<div class="form-group">
										...
										<input type="month" id="month_filter" value="<?= date('Y-m')?>" class="form-control" required />
									</div>
								</div>
								<div class="col-12">
...
function loan_accept_function(id){
	if(id != ''){
		if(confirm("Are you sure?")){
			$.ajax({
				url: "<?=base_url('assets/ajax/form_submit/accounting/aproval/account_loan_accept_ssubmit.php'); ?>",			
				method: "POST",
				data: {accept_id:id},
				beforeSend:function(){
...
$('#month_filter').on('change', () => {
	var ajax_data = "<?=base_url('assets/ajax/data_table/accounting/aproval/employee_accounts_loan_approval_datatable.php'); ?>?month_filter="+$('#month_filter').val();
...
$(document).ready(function() {
    var table_booking = $('#booking_data_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/accounting/aproval/employee_accounts_loan_approval_datatable.php?month_filter=" + $('#month_filter').val(),
		dom: 'lBfrtip',
