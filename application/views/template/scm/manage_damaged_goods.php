	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form action="" id="damaged_product_form_all" method="post">
				...
				<div class="modal-footer">
					<div id="damage_button">
						<select name="damaged_product_action" id="damaged_product_action">
...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Manage Damaged Goods</h1>
				</div> 
				<div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
							<table class="table table-sm text-center table-bordered table-hover" id="damaged_goods_datatable">
                                <thead>
									<tr>
										<th>id</th>
										<th>type_name</th>
...
$('#damaged_product_form_all').on('submit', function () {
    ...
    $.ajax({
        ...
        success: function (data) {
			let info = JSON.parse(data);
			if(info.error){
				alert_for_js('danger', 'Something went wrong!');
			}else{
				alert_for_js('success', 'Successfull!');
			}
			trigger_alert();
        }
    });
...
$(document).ready(function () {
    var purchase_order = $('#damaged_goods_datatable').DataTable({
		"paging": true,
		"lengthChange": false,
		"searching": true,
		"order": [[ 0, "desc" ]],
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/scm/damaged_goods_datatable.php",
        columnDefs: [
