                ...
                <div class="col-md-4">
                    <div class="card card-success">
                        <div class="card-header">
                            Add Product Extra Specifications/Configuration
                        </div>
                        <form action="<?=base_url()?>admin/scm/product-type/extra-specification-insert" method="post">
                            <div class="card-body">
                                <input class="form-control" type="text" name="product_extra_measurement_name" placeholder="Enter Product Specification">
                            </div>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
							<table class="table table-sm text-center" id="product_scales_table">
                                ...
                                <tbody>
                                    <?php foreach($extra_specifications as $extra_specification){ ?>
                                    <tr>
                                        <td><?php echo $extra_specification->id;?></td>
                                        <td><?php echo $extra_specification->name;?></td>
                                        <td><?php echo ($extra_specification->status == '1') ? '<span class="badge badge-primary">Active</span>' : '<span class="badge badge-danger">Inactive</span>'; ?></td>
                                        <td>
                                            <div class="row justify-content-center" >
                                                <div class="col-sm">
                                                    <button data-target="#edit_scale" data-toggle="modal" class="btn btn-info btn-xs" onclick="edit_scale(this.value)" value="<?php echo $extra_specification->id.'~'.$extra_specification->name.'~'.$extra_specification->status; ?>"><i class="far fa-edit"></i></button>
                                                </div>
                                                <div class="col-sm">
                                                    <form action="<?=base_url()?>admin/scm/product-type/scale-delete" method="post">
                                                        <input type="hidden" name="scale_id" value="<?php echo $extra_specification->id; ?>">
