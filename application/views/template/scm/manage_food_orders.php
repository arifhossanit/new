...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Manage Food Orders</h1>
				</div> 
				<div class="col-sm-6">
...
$('#receive_product_form').on('submit', function () {
	...
	$.ajax({
        type: 'post',
        data: {product_type, purchase_order, product_id,damaged_amount,stolen_amount,received_amount,food: 'yes'},
...
$(document).ready(function () {
    var purchase_order = $('#purchase_order_table').DataTable({
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/scm/food_order_datatable.php"
    });
});
</script>