...
<div class="content-wrapper">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Out of Order Goods</h1>
				</div> 
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
						<li class="breadcrumb-item"><a href="<?=base_url();?>">SCM</a></li>
						<li class="breadcrumb-item active">Out of Order Goods</li>
					</ol>
				</div> 
			</div> 
		</div> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
							<table class="table table-sm text-center table-bordered table-hover" id="out_of_order_goods_datatable">
                                <thead>
									<tr>
										<th>id</th>
										<th>type_name</th>
...
$(document).ready(function () {
    var purchase_order = $('#out_of_order_goods_datatable').DataTable({
		"paging": true,
		"lengthChange": false,
		"searching": true,
		"order": [[ 0, "desc" ]],
		...
		"processing": true,
        "serverSide": true,
        "ajax": "<?=base_url(); ?>assets/ajax/data_table/scm/out_of_order_goods_datatable.php",
        columnDefs: [
