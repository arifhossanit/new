...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Document Type</h1>
          </div> 
          <div class="col-sm-6">
				...
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Document Type information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="form-group">
									...
									<input name="document_type" value="<?php if(!empty($edit)){ echo $edit->document_type; } ?>" type="text" class="form-control" placeholder="Document Type" required>
								</div>
								<div class="form-group">
