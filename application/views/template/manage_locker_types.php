...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Locker Type</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">Manage Locker Type</li>
            </ol>
          </div> 
        </div> 
      </div> 
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Locker Type information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<input name="locker_type" value="<?php if(!empty($edit)){ echo $edit->locker_type; } ?>" type="text" class="form-control" placeholder="Locker Type" required>
								</div>
								<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Locker Type List</h3>
						</div>
						<div class="card-body">
