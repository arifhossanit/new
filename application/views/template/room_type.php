...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Room Type</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">Manage Room Type</li>
            </ol>
          </div> 
        </div> 
      </div> 
				...
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Room Type information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="form-group">
									...
									<select id="package_category" name="package_category" class="form-control select2" required>
									</select>
								</div>
								<div class="form-group">
									<label>Room Type</label>
									<input name="room_type" value="<?php if(!empty($edit)){ echo $edit->room_type; } ?>" type="text" class="form-control" placeholder="Room Type" required>
								</div>
								<div class="form-group">
