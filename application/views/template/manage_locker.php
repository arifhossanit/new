...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Locker</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item active">Manage Locker</li>
            </ol>
          </div> 
        </div> 
      </div> 
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Locker information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label>Select Locker Type</label>
									<select id="locker_type" name="locker_type" class="form-control select2" required>										
									</select>
								</div>
								<div class="form-group">
									<label>Locker Numbers</label>
									<input name="locker_number" value="<?php if(!empty($edit)){ echo $edit->locker_number; } ?>" type="text" class="form-control" placeholder="Locker Number" required>
								</div>
								<div class="form-group">
									<label>Locker Price</label>
									<input name="price" value="<?php if(!empty($edit)){ echo $edit->price; } ?>" type="number" class="form-control" placeholder="Locker price" required>
								</div>
								<div class="form-group">
				...
				<div class="col-sm-8">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Locker List</h3>
						</div>
						<div class="card-body">
...
$('document').ready(function(){
	$("#branch_id").on("change",function(){
		...
		if(branch_id != ''){
			$.ajax({  
				url:"<?=base_url('assets/ajax/select_locker_type_options.php');?>",  
				method:"POST",  
