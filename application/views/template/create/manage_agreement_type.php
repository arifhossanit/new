...
<div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manage Agreement Type</h1>
          </div> 
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Home</a></li>
              <li class="breadcrumb-item"><a href="<?=base_url();?>">Create</a></li>
              <li class="breadcrumb-item active">Manage Agreement Type</li>
            </ol>
          </div> 
        </div> 
      </div> 
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Input Agreement Type information</h3>
						</div>
						<form role="form" action="<?=current_url(); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="card-body">							
								<div class="form-group">
									<label>Agreement Type Name</label>
									<input name="agreement_type_name" value="<?php if(!empty($edit)){ echo $edit->agreement_type_name; } ?>" type="text" class="form-control" placeholder="Agreement Type Name" required>
								</div>
				...
				<div class="col-sm-8">
					<div class="card card-success">
						<div class="card-header">
							<h3 class="card-title">Agreement Type List</h3>
						</div>
						<div class="card-body">
